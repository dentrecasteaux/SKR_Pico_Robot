...
namespace Config {
  ...
  constexpr float DEFAULT_ACCELERATION_MM_PER_SECOND_SQUARED = 150.0F;
  ...
  constexpr float MAX_LINEAR_SPEED_MM_PER_SECOND = 1000.0F;
  constexpr float MAX_TURN_SPEED_DEGREES_PER_SECOND = 360.0F;
